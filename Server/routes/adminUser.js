...
const sendMail = (name, recipient, password) => {
    ...
    var url = "http://localhost:3000/admin/login"

    var content = "This is an autogenerated mail by the Dress Me. This is to inform you that an account is created for you in the Dress Me official website with the email " + recipient + " . Please login to the website using the link " + url + " and use email address as " + recipient + " and password as " + password + " for your first login.";
