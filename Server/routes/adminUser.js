...
const sendMail = (name, recipient, password) => {
    ...
    var content = "This is an autogenerated mail by the dressMe. This is to inform you that an account is created for you in the DressMe official website with the email " + recipient + " . Please login to the website using the link and use email address as " + recipient + " and password as " + password + " for your first login.";
    //document.getElementById("econtent").innerHTML = content;
    const data = {
        from: "Dress Me <nisansala.d9710@gmail.com>",
        to: recipient,
